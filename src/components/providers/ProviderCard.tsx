      ...
      <div className="p-5">
        ...
        <div className="flex items-start gap-4">
          <div className="relative shrink-0">
            <img
              src={provider.avatar}
              alt={provider.name}
              className="h-14 w-14 rounded-full object-cover ring-2 ring-light"
            />
            {provider.verified && (
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-1 flex items-center gap-1.5">
              ...
              <span className="text-xs text-muted">({provider.reviewCount} reviews)</span>
            </div>
            {/* Location */}
        ...
        <div className="mt-4 flex items-center justify-between border-t border-border pt-4">
          ...
          <div className="flex gap-2">
            <Button variant="outline" size="sm" href={`/provider/${provider.id}`}>
              View Profile
            </Button>
            <Button size="sm" href={`/book/${provider.id}`}>
              Book Now
            </Button>
          </div>
        </div>
